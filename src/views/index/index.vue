...
<script>
	...
	export default {
		...
		data() {
			return {
				imgs: [{
					...
					{
						imgSrc: "https://www.google.cn/landing/cnexp/google-search.png"
					}
				],
				grid: [{
					category: '1',
		...
		methods: {
			beforeCreat() {
				document.querySelector('body').setAttribute('style', 'background-color: #F4F2F2;');
			}
		}
	}
</script>
