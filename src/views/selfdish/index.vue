        ...
        <div class="flex-row" style="justify-content: space-around;align-items: center;">
          ...
          <div>
            <div class="flex-row" style="align-items: center; margin: 5px;">
              <h4>味道</h4>
              <van-rate
                v-model="myComment.canteen.taste"
                allow-half
                void-icon="star"
                void-color="#eee"
              />
            ...
            <div class="flex-row" style="align-items: center; margin: 5px;">
              <h4>服务</h4>
              <van-rate
                v-model="myComment.canteen.service"
                allow-half
                void-icon="star"
                void-color="#eee"
              />
    ...
    return {
      ...
      comment: {
        food: {
          ...
          price: 5,
          img_url:
            "http://canteen.tonglingok.com/static/image/20190810/ab9ce8ff0e2c5adb40263641b24f36d4.png",
          chef: "李大厨",
          comments: [
            {
              id: 4,
