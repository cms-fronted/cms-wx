      ...
      <div class="flex-row" style="justify-content: space-around;align-items: center;">
        ...
        <div>
          <div class="flex-row" style="align-items: center; margin: 5px;">
            <h4>味道</h4>
            <van-rate
              v-model="comment.canteenScore.taste"
              allow-half
              void-icon="star"
              readonly
              void-color="#eee"
          ...
          <div class="flex-row" style="align-items: center; margin: 5px;">
            <h4>服务</h4>
            <van-rate
              v-model="comment.canteenScore.service"
              allow-half
              void-icon="star"
              readonly
              void-color="#eee"
      ...
      <div class="flex-row" style="border:1px solid #CCCCCC;">
        ...
        <div style="margin: 5px 10px;width: 35%; line-height: 30px;">
          <van-image
            ...
            :src="'http://canteen.tonglingok.com/'+comment.food.img_url"
          />
...
import { getFoodList, getDiningType, getDinnerInfo } from "@/api/selfDish.js";
...
export default {
  ...
  mounted() {
    this.scrollH =
      window.innerHeight -
      this.$refs.category.getBoundingClientRect().bottom -
      40;
