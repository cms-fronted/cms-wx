...
export function saveCanteenComment(data) {
	return request({
		url: '/api/v1/canteen/saveComment',
		method: 'post',
		data
	});
};

//提交订单 http://canteen.tonglingok.com/api/api/v1/order/personChoice/save
...
export function getDinnerInfo(data) {
	return request({
		url: '/api/v1/order/personChoice/info',
		mathod: 'get',
		params: data
	});
};
